			...
			<div class="container">
				<div class="row">
												...
												<div class="row">
													<div class="col-md-12 col-sm-6">
														<div class="desc">
															...
															<p>Pesona wisata Bali tidak hanya pada keindahan alamnya saja, ada pula berbagai bangunan bersejarah yang menyimpan sejumlah kisah menarik.

																Untuk tujuan ataupun aktifitas wisata, berkunjung ke tempat-tempat bersejarah menjadi hal yang menarik saat wisatawan berkunjung ke Bali.
																
																Wisata budaya dan sejarah di Bali ini menjadi bagian penting, saat wisatawan merencankan perjalanan tour untuk menikmati liburan di Bali.
																
																Berkembangnya industri pariwisata cukup mempengaruhi, sejumlah bangunan bersejarah, terpelihara dengan baik.</p>
												...
												<div class="row">
													<div class="col-md-12 col-sm-6">
														<div class="desc">
															<h2>TRAVEL PLAN</h2>
															<!-- <p class="price"><span>$45</span> <small>/ night</small></p> -->
															<p>Siap untuk menjelajahi Bali ? Atau melihat indahnya sunrise/sunset di spot terbaik dan pulang dengan foto foto terbaik dari tim kita? Yuk booking tour kalian sekarang !
																<br>
																- Tanah Lot<br>
																- GWK<br>
																- Nusa Penida<br>
												...
												<div class="row">
													<div class="col-md-12 col-sm-6">
														<div class="desc">
															<h2>INCLUDE</h2>
															<!-- <p class="price"><span>$45</span> <small>/ night</small></p> -->
															<p> - Mobil ( Untuk 2-6 )<br>
																- 2 Mobil ( Untuk 7-12 Orang )<br>
																- Travel ( Untuk 12-20 Orang )<br>
																- Bus ( Untuk 20> Orang)<br>
																- Guide<br>
																- Sopir<br>
																- Bensin<br>
																- Tiket Masuk<br>
																- Unlimited Photo Documentation<br>
																- 1 Minute Video Documentation ( +duration per minute Rp.750.000,- )</p>
															<!-- <p><a href="#" class="btn btn-primary">Book Now!</a></p> -->
														</div>
													</div>
												</div>
					...
					<div class="col-md-3">
						<div class="sidebar-wrap">
							<div class="side search-wrap animate-box">
								<h3 class="sidebar-heading">Price List Open Trip</h3>
				                ...
				                <div class="col-md-12">
									<p><a href="booking.php" class="btn btn-primary">Book Now!</a></p>
					...
					<div class="col-md-3">
						<div class="sidebar-wrap">
							<div class="side search-wrap animate-box">
								<h3 class="sidebar-heading">Price List Private Trip</h3>
								<form method="post" class="colorlib-form">
				              	<div class="row">
				                <div class="col-md-12">
				                  <div class="form-group">
				                    <label> One Day<br>
										2-3 Person   Rp.1.000.000,-<br>
										4-14 Person  Rp.950.000,-<br>
										15-24 Person Rp.900.000,-<br>
										25 Person    Rp.850.000,-<br>
										<br>
										Two Day<br>
										2-3 Person   Rp.1.250.000,-<br>
										4-6 Person   Rp.1.150.000,-<br>
										7-10 Person  Rp.1.100.000,-<br>
										8-20 Person  Rp.1.050.000,-<br>
										20> person	 Rp.1.000.000,-<br>
										<br>
										Three Day<br>
										2-3 Person   Rp.1.900.000,-<br>
										4-6 Person   Rp.1.800.000,-<br>
										7-10 Person  Rp.1.700.000,-<br>
										8-20 Person  Rp.1.600.000,-<br>
										20> person	 Rp.1.500.000,-<br>
										<br>
										Four Day<br>
										2-3 Person   Rp.2.500.000,-<br>
										4-6 Person   Rp.2.400.000,-<br>
										7-10 Person  Rp.2.300.000,-<br>
										8-20 Person  Rp.2.200.000,-<br>
										20> person	 Rp.2.000.000,-<br>
										</label>
				                  </div>
				                </div>
				                <div class="col-md-12">
