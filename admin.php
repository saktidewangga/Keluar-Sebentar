...
if((isset($_GET['aksi']))&&(isset($_GET['data']))){ 
	if($_GET['aksi']=='hapus'){
		$id=$_GET['data']; 
		//hapus 
		$sql_da = "delete from `tbl_pemesanan` where `id` = '$id'"; 
		mysqli_query($db,$sql_da); 
} 
} 
?>
			...
			<div class="flexslider">
				...
				<!--DATA PEMESAN-->
				  ...
				  <?php include("config.php"); ?>
					<form action="booking.php?=konfirmasi_booking" method="POST" enctype="multipart/form-data">
							<div class="col-md-12">
								  ...
								  <tr>
									  ...
									  <th class="text-center"><b>IDENTITIES</b></th>
									  <th class="text-center"><b>ADDRESS</b></th>
                                      <th class="text-center"><b>TELP</b></th>
                                      <th class="text-center"><b>EMAIL</b></th>
                                      <th class="text-center"><b>DATE</b></th>
                                      <th class="text-center"><b>TRIP</b></th>
									  <th class="text-center"><b>ACTION</b></th>
								  </tr>
								  <?php 
								  $sql_a = "select `id`, `nama` , `identitas`, `alamat`, `telp`, `email`, `tanggal`, `trip` from `tbl_pemesanan` order by `id`";
								  $query = mysqli_query($db,$sql_a);
								  $no=1;
								  while($data_a = mysqli_fetch_row($query)){
									  $id = $data_a[0];
									  $nama = $data_a[1];;
									  $identitas = $data_a[2];
									  $alamat = $data_a[3];
								  ...
								  <tr>
									  ...
									  <td><center><?php echo $identitas;?></center></td>
                                      ...
                                      <td><center><?php echo $trip;?></center></td>
									  <td><center><a href="edit_booking.php?data=<?php echo $id;?>">Edit</a> |
										<a href="javascript:if(confirm('Anda yakin ingin menghapus data 
										<?php echo $id.' - '.$nama; ?>?')) window.location.href = 'admin.php?aksi=hapus&data=<?php echo $id;?>'"> Delete </a> </center>
									  </td>
